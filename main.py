from Pieces import Board,Piece,pieceGenerator
from parameters import HEIGHT,WIDTH
from GUI_Pieces import MainSurface

class Solver:
    def emptyTopLeft(self):
    ...
    def numberOfRotations(self,pieceType):
        """
    ...
    def recursiveAlgorithm(self,piecetype_list:list[Piece]):
        '''
        ...
        '''
        topleft = self.emptyTopLeft()
        for newPieceType in piecetype_list:
            for rot in range(self.numberOfRotations(newPieceType)):
                ...
                if board.addPiece(id,newPiece,topleft):
                    ...
                    if new_piecetype_list == []:
                        ...
                        if self.recursiveAlgorithm(new_piecetype_list):
    ...
    def solve(self,exerciseSetup_pieces:list,exerciseSetup_pins:list[str]):
        '''
        ...
        if self.recursiveAlgorithm(piecetype_list):
...
if __name__ == '__main__':
    ...
    solver.solve(exerciseSetup_pieces,exerciseSetup_pins)
